---
title: "Notes Toward a Text-Based Ontology in the Age of Executable Language"
date: 2026-05-19
type: essay
status: draft
focus-keyword: "text-based ontology"
meta-description: "An essay on executable language, symbolic infrastructure, and the text-based ontologist as a figure for making sense of AI, prompts, archives, and reality construction."
tags:
...
The [[The Text-Based Ontologist|text-based ontologist]] works directly with these architectures.
...
The text-based ontologist, therefore, becomes something like an infrastructure mystic. Part philosopher, part systems thinker, part occult engineer. Someone attempting to understand what happens when language becomes the [[Text as Universal Substrate|universal interface layer]] between humans, machines, institutions, and reality models themselves.
...
A [[Sigil|sigil]] is a compressed intention encoded symbolically to alter behaviour through subconscious channels. A prompt is a compressed intention encoded symbolically to alter machine behaviour through statistical inference. The mechanisms differ. The structural resemblance remains uncanny.
...
Because the psychological consequence of existing inside text-mediated reality is profound. One begins to experience life itself as editable. Identities become revisable drafts. [[Narrative Alchemy|Narratives]] become modular. Selves become version-controlled symbolic constructs moving through overlapping systems of interpretation.
...
This is why [[I Link Therefore I Cohere|notebook culture]] has become so important for many contemporary thinkers. Obsidian vaults. Linked notes. Knowledge graphs. Constellational writing systems. These are not merely productivity tools. They are attempts to externalise cognition spatially inside textual environments.
...
The [[the-archive-is-alive|archive]] is no longer passive storage.
...
One begins to think with [[I Link Therefore I Cohere|tools]] rather than merely through them.
...
This perhaps explains the growing fascination many people feel toward practices like journaling, [[Psychogeography|psychogeography]], analogue note-taking, tarot, contemplative walking, and tactile rituals. These practices reintroduce friction into environments tending toward total abstraction. They restore symbolic engagement to embodied temporality.
...
Psychogeography is ultimately a form of [[Embodied Ontology|embodied ontology]]. The city read symbolically through movement. Infrastructure is becoming psyche. Architecture becoming narrative. The walker discovers that space itself carries ideological assumptions and emotional residue.
...
- [[Prompt Engineering as Ontological Practice]] *(depth node to write)*
- [[Semantic Architecture]] *(depth node to write)*
- [[Ontology Disguised as Vocabulary]] *(depth node to write)*
- [[The Self as Exoskeletal]] *(depth node to write)*
- [[Embodied Ontology]] *(depth node to write)*
- [[The Archive That Thinks Back]] *(depth node to write)*
- [[Reality Tunnels in the Age of AI]] *(depth node to write)*
